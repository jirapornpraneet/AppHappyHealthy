...
public class DiabetesTABLE {
    ...
    public static final String Diabetes_CostSugar = "D_CostSugar";
    ...
    //Add New Value
    //Add New Value
    public long addNewValueToSQLite(String str_D_Date,  String str_D_Time, int intCostSugar) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(Diabetes_Date, str_D_Date);
        contentValues.put(Diabetes_Time, str_D_Time);
        contentValues.put(Diabetes_CostSugar, intCostSugar);
