...
public class Pressure extends AppCompatActivity {
    ...
    private String findMyLevelPressureTop() {
        ...
        if (IntCostPressureTop >= 180 ) {//ระดับอันตราย
            CostTop = 0;
        } else if ((IntCostPressureTop >= 160) & (IntCostPressureTop <180)) {//ระดับสูงมากและอันตราย
            CostTop = 1;
        } else if ((IntCostPressureTop >= 140) & (IntCostPressureTop <160)){//ระดับสูงมาก
            CostTop = 2;
        } else if ((IntCostPressureTop >= 130 ) & (IntCostPressureTop <140)) {//ระดับค่อนข้างสูง
            CostTop = 3;
        } else if ((IntCostPressureTop >= 120 ) & (IntCostPressureTop <130)) {//ระดับปกติ
            CostTop = 4;
        } else if ((IntCostPressureTop >= 90 ) & (IntCostPressureTop <120)) {//ระดับเหมาะสม
            CostTop = 5;
        } else {
            CostTop = 0;
        }
